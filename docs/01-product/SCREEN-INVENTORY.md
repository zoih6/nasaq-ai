...
>
> **ملحق U2 الحاكم للخدمات:** مخزون Ask/Learn/Research/Create/Code/Analyze/Explore/Library الجديد ومعايير P0 موجود في [`U2-SERVICE-DEPTH.md`](U2-SERVICE-DEPTH.md). لا يعني وجود صفحات الخدمات العامة الحالية اكتمال عمقها.
